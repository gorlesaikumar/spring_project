...
<%@page import="com.controllers.Category"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
   <%@ page import="java.io.*,java.util.*" %> 
   <%@ page import="com.controllers.Products" %>
   <%@ page import="com.controllers.Category" %>
...
<body>
        ...
        <div class="navbar">
            ...
            <% List<Products> c = Category.retrivecategory(); 
             ...
             for(Products p : c){
                 ...
                 <button class = "active" type="submit" value="<%=p.getCategory()%>" name="market" style="cursor: pointer;" ><%=p.getCategory()%></button></form>
            ...
            <button type="submit" value="${p.id}" name="item"  >search</button>
             ...
             <div class="cart">
            <form action="cartpage"><button class="active" type="submit" style="border-radius: 10px; background-color: orange; padding: 3px 15px; ">Cart</button></form>
                
                <a class = "loginstyle" href="loginform.jsp">Login</a>
